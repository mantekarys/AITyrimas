...
def steps_main():
    env = CarlaEnv('carla-rl-gym-v0', time_limit=300, initialize_server=False, random_weather=False, synchronous_mode=True, show_sensor_data=True, random_traffic=False)  # <-- Alternative way to create the environment
